...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "tour.2.r": "And all of you?",
    "tour.3": "Tap anyone you want to know; we always stop. The light you earn spends at the depot.",
    "tour.3.r": "I'll go write.",
    "tour.end": "Good. When your window lights up, we can see it from here.",
  ...
  zh: {
    ...
    "tour.2.r": "那你們呢?",
    "tour.3": "想認識誰就點誰,我們都會停下來。賺到的光,補給站換得到東西。",
    "tour.3.r": "我去寫了。",
    "tour.end": "好。你的窗亮起來的時候,我們在這裡看得見。",
