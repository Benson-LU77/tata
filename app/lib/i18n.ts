...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "settings.where.native": "Every page is a .md file on this device — Files App › Tata.",
    "welcome.mail": "A letter for you",
    "quest.delivered": "Favour delivered · +6 W",
    "tour.1": "New here? Every tower on this street is a night somebody wrote down.",
    ...
    "tour.c4": "The depot. The light you earn by writing spends there.",
  ...
  zh: {
    ...
    "settings.where.native": "每一頁都是這台裝置上的 .md 檔——「檔案」App › Tata。",
    "welcome.mail": "給你的信",
    "quest.delivered": "人情送到了 · +6 W",
    "tour.1": "新來的吧?這條街上每一棟樓,都是有人寫下的一夜。",
    "tour.1.r": "誰寫的?",
