...
export const VOICE_LINES: LineDef[] = [
  ...
  // ---- second wave: the same twelve voices, grown closer ----
  // stationmaster
  { weight: 4, tier: 2, topic: "night", when: (c) => c.profession === "stationmaster",
    en: "23:40 arrival. Right on your average. It's a good average.", zh: "23:40 進站,跟你的平均一致。是個好平均。" },
  { weight: 4, tier: 2, topic: "city", when: (c) => c.profession === "stationmaster",
    en: "New building off the timetable again. The city never files paperwork.", zh: "又一棟樓沒照時刻表長出來。這座城從不打報告。" },
  { weight: 4, tier: 2, topic: "writing", when: (c) => c.profession === "stationmaster",
    en: "Your window lights up on schedule. Only punctual thing on this street.", zh: "你的窗準時亮起。這條街上就它守時。" },
  { weight: 4, tier: 3, topic: "you", when: (c) => c.profession === "stationmaster",
    en: "I don't check the clock when you round the corner. That's the clock's problem now.", zh: "你轉過街角的時候,我不看錶了。那是錶的事了。" },
  { weight: 5, tier: 4, topic: "you", when: (c) => c.profession === "stationmaster",
    en: "Trains keep time. You keep something better. Off you go.", zh: "火車守的是時間,你守的是更好的東西。去吧。" },
  // gardener
  { weight: 4, tier: 2, topic: "weather", when: (c) => c.profession === "gardener" && c.weather === "rain",
    en: "Good rain. Slow rain. The kind roots wait for.", zh: "好雨,慢慢下的那種。根等的就是這種。" },
  { weight: 4, tier: 2, topic: "writing", when: (c) => c.profession === "gardener",
    en: "Pages are seeds. Some come up years later. Keep planting.", zh: "每一頁都是種子,有些要好幾年才發芽。繼續種。" },
  { weight: 4, tier: 2, topic: "city", when: (c) => c.profession === "gardener",
    en: "The pines lean toward the lit windows. Nobody teaches them that.", zh: "松樹會朝亮著的窗傾過去,沒人教它們這個。" },
  { weight: 4, tier: 3, topic: "them", when: (c) => c.profession === "gardener",
    en: "I planted something unmarked by your building. You'll see.", zh: "我在你的樓邊種了個沒掛牌子的東西。你會看到的。" },
  { weight: 5, tier: 4, topic: "you", when: (c) => c.profession === "gardener",
    en: "Some things you stop watering and they die. Not this. Not us.", zh: "有些東西你不澆就死了。這個不是,我們不是。" },
  // courier
  { weight: 4, tier: 2, topic: "city", when: (c) => c.profession === "courier",
    en: "Shortcut through month three's alley. Don't tell the stationmaster.", zh: "三月島的巷子有捷徑。別跟站長說。" },
  { weight: 4, tier: 2, topic: "writing", when: (c) => c.profession === "courier",
    en: "Every letter I carry weighs something. Yours would weigh right.", zh: "我送的每封信都有重量。你寫的那種,重量會剛剛好。" },
  { weight: 4, tier: 2, topic: "night", when: (c) => c.profession === "courier",
    en: "Last run of the night. I stretch this one out on purpose.", zh: "今晚最後一趟。這趟我故意跑慢一點。" },
  { weight: 4, tier: 3, topic: "you", when: (c) => c.profession === "courier",
    en: "I know every door in this city. Yours is the one I knock slower on.", zh: "這座城每扇門我都認得。只有你那扇,我會敲得比較輕。" },
  { weight: 5, tier: 4, topic: "them", when: (c) => c.profession === "courier",
    en: "If I ever retire, your street's the one I'll still walk. Off duty.", zh: "哪天我不送了,還是會走你這條街。下了班也走。" },
  // astronomer
  { weight: 4, tier: 2, topic: "night", when: (c) => c.profession === "astronomer",
    en: "Two satellites crossed tonight. They won't meet again for years. They managed a blink.", zh: "今晚兩顆衛星交會,下次要好幾年後。它們還是眨了一下。" },
  { weight: 4, tier: 2, topic: "writing", when: (c) => c.profession === "astronomer",
    en: "Your light pollution is up 3%. As an astronomer: bad. As your neighbour: keep going.", zh: "你的光害上升了 3%。以天文學家來說:不好。以鄰居來說:繼續。" },
  { weight: 4, tier: 2, topic: "city", when: (c) => c.profession === "astronomer",
    en: "From the observatory this street is one bright line. Guess which pixel is you.", zh: "從天文台看,這條街是一道亮線。猜猜哪個像素是你。" },
  { weight: 4, tier: 3, topic: "them", when: (c) => c.profession === "astronomer",
    en: "I mapped forty thousand stars this year. I still look for the same window first.", zh: "今年我編了四萬顆星的目錄,但每晚還是先找同一扇窗。" },
  { weight: 5, tier: 4, topic: "you", when: (c) => c.profession === "astronomer",
    en: "The universe is mostly empty. Statistically, you shouldn't be here. Thanks for ignoring that.", zh: "宇宙大部分是空的。統計上,你不該在這裡。謝謝你不管統計。" },
  // baker
  { weight: 4, tier: 2, topic: "night", when: (c) => c.profession === "baker",
    en: "Night's the proofing hour. For dough. For people too.", zh: "夜晚是發酵的時辰。麵團是,人也是。" },
  { weight: 4, tier: 2, topic: "you", when: (c) => c.profession === "baker",
    en: "You've thinned out. Words don't feed the writer. Remember dinner.", zh: "你瘦了。字餵不飽寫字的人,記得吃飯。" },
  { weight: 4, tier: 2, topic: "city", when: (c) => c.profession === "baker",
    en: "A city rises like bread. Slow, warm, and it falls if you slam the door.", zh: "城市像麵包一樣長高。要慢,要溫,摔門就塌。" },
  { weight: 4, tier: 3, topic: "them", when: (c) => c.profession === "baker",
    en: "I knead when I worry. Lots of bread lately. Ignore that.", zh: "我一擔心就揉麵,最近麵包有點多。別多想。" },
  { weight: 5, tier: 4, topic: "you", when: (c) => c.profession === "baker",
    en: "You get the corner table forever. There's no table. You understand me.", zh: "角落那桌永遠是你的。雖然沒有桌子。你懂我的意思。" },
  // shipwright
  { weight: 4, tier: 2, topic: "city", when: (c) => c.profession === "shipwright",
    en: "Buildings are ships that chose to stay. Respect that.", zh: "樓就是決定不走的船。要尊敬這件事。" },
  { weight: 4, tier: 2, topic: "night", when: (c) => c.profession === "shipwright",
    en: "Dock's quiet. Ships sleep floating. Trick is trusting the water.", zh: "船塢很靜。船是浮著睡的,訣竅是信得過水。" },
  { weight: 4, tier: 2, topic: "you", when: (c) => c.profession === "shipwright",
    en: "You walk steadier than when you arrived. Keel's set.", zh: "你走路比剛來的時候穩了。龍骨定了。" },
  { weight: 4, tier: 3, topic: "them", when: (c) => c.profession === "shipwright",
    en: "Kept a plank from my first wreck. Some failures are load-bearing.", zh: "我第一艘沉船的板子我還留著。有些失敗是承重的。" },
  { weight: 5, tier: 4, topic: "you", when: (c) => c.profession === "shipwright",
    en: "I'd sail anything you built. That's the whole review.", zh: "你造的船我都敢開。評語就這一句。" },
  // lampkeeper
  { weight: 4, tier: 2, topic: "city", when: (c) => c.profession === "lampkeeper",
    en: "Third lamp flickers. It's fine. It's thinking.", zh: "第三盞燈在閃。沒事,它在想事情。" },
  { weight: 4, tier: 2, topic: "writing", when: (c) => c.profession === "lampkeeper",
    en: "Your window. My lamps. Same job.", zh: "你的窗,我的燈。同一份工作。" },
  { weight: 4, tier: 2, topic: "weather", when: (c) => c.profession === "lampkeeper" && c.weather === "fog",
    en: "Fog tonight. Lamps earn their keep.", zh: "起霧了。燈今晚沒白點。" },
  { weight: 4, tier: 3, topic: "them", when: (c) => c.profession === "lampkeeper",
    en: "Forty-one lamps. I know which one you read under. Forty-two.", zh: "四十一盞燈。我知道你在哪一盞下面看書。四十二。" },
  { weight: 5, tier: 4, topic: "you", when: (c) => c.profession === "lampkeeper",
    en: "Yours stays lit last. Keeper's discretion.", zh: "你那盞最後熄。管燈的,有這點權限。" },
  // poet
  { weight: 4, tier: 2, topic: "night", when: (c) => c.profession === "poet",
    en: "The night rhymes with itself. Lazy, but it works.", zh: "夜跟夜自己押韻。偷懶,但有效。" },
  { weight: 4, tier: 2, topic: "writing", when: (c) => c.profession === "poet",
    en: "You write every night and call it nothing. I call one good line a career.", zh: "你每晚都寫,還說沒什麼。我一句像樣的就敢吃一輩子。" },
  { weight: 4, tier: 2, topic: "city", when: (c) => c.profession === "poet",
    en: "I tried to rhyme this street. It refused. Prose district.", zh: "我想押這條街的韻,它不肯。散文街區。" },
  { weight: 4, tier: 3, topic: "them", when: (c) => c.profession === "poet",
    en: "I finish more poems since you started walking past. Correlation. Obviously.", zh: "自從你常走過,我寫完的詩變多了。相關而已,當然。" },
  { weight: 5, tier: 4, topic: "you", when: (c) => c.profession === "poet",
    en: "I stopped writing about the moon. There are closer lights.", zh: "我不寫月亮了。有更近的光。" },
  // tailor
  { weight: 4, tier: 2, topic: "weather", when: (c) => c.profession === "tailor" && c.weather === "snow",
    en: "Snow. The city wears it well. Off the rack, too.", zh: "下雪了。這座城穿得挺好,還是成衣呢。" },
  { weight: 4, tier: 2, topic: "writing", when: (c) => c.profession === "tailor",
    en: "A page is a fitting. Cut, pin, take it in tomorrow.", zh: "一頁就是一次試身。先裁,別縫死,明天再修。" },
  { weight: 4, tier: 2, topic: "city", when: (c) => c.profession === "tailor",
    en: "The skyline needs hemming on the east side. I'd charge the moon.", zh: "天際線東邊該收個邊。工錢我會開天價。" },
  { weight: 4, tier: 3, topic: "them", when: (c) => c.profession === "tailor",
    en: "I mend things people gave up on. It's not a metaphor. Fine, it's a metaphor.", zh: "我修的都是別人放棄的東西。不是比喻。……好吧,是比喻。" },
  { weight: 5, tier: 4, topic: "you", when: (c) => c.profession === "tailor",
    en: "I know your measurements by heart now. Sleeve, stride, silence. All of it fits.", zh: "你的尺寸我背起來了。袖長、步幅、安靜的長度。都合身。" },
  // archivist
  { weight: 4, tier: 2, topic: "night", when: (c) => c.profession === "archivist",
    en: "Nights file themselves under 'quiet'. Tonight resists. Interesting.", zh: "夜晚通常自動歸在「安靜」條目下。今晚不肯。有意思。" },
  { weight: 4, tier: 2, topic: "city", when: (c) => c.profession === "archivist",
    en: "This street has four spellings in the records. It answers to all of them.", zh: "這條街在檔案裡有四種寫法,每一種它都答應。" },
  { weight: 4, tier: 2, topic: "you", when: (c) => c.profession === "archivist",
    en: "Your file is getting thick. Best kind of problem.", zh: "你的卷宗越來越厚了。這是最好的那種麻煩。" },
  { weight: 4, tier: 3, topic: "them", when: (c) => c.profession === "archivist",
    en: "I archive endings for a living. I've stopped reading yours ahead.", zh: "我的工作是歸檔結局。但你的,我不先翻了。" },
  { weight: 5, tier: 4, topic: "you", when: (c) => c.profession === "archivist",
    en: "Some records I keep in the fireproof cabinet. You're filed there.", zh: "有些紀錄我放防火櫃。你歸在那裡。" },
  // stargazer
  { weight: 4, tier: 2, topic: "night", when: (c) => c.profession === "stargazer",
    en: "The galaxy band tilted a little. Or I did. One of us is dancing.", zh: "銀河帶斜了一點。也可能是我斜了。總之有一方在跳舞。" },
  { weight: 4, tier: 2, topic: "writing", when: (c) => c.profession === "stargazer",
    en: "Stars are just far letters. Yours arrive faster.", zh: "星星不過是很遠的信。你的信比較快。" },
  { weight: 4, tier: 2, topic: "weather", when: (c) => c.profession === "stargazer" && c.weather === "fog",
    en: "Can't see the sky tonight. It knows where I am. We're fine.", zh: "今晚看不到天空。它知道我在哪,我們沒事。" },
  { weight: 4, tier: 3, topic: "them", when: (c) => c.profession === "stargazer",
    en: "People ask what I'm looking for up there. Lost the question years ago. Kept the looking.", zh: "常有人問我在天上找什麼。問題早就丟了,只留下看這件事。" },
  { weight: 5, tier: 4, topic: "you", when: (c) => c.profession === "stargazer",
    en: "I watch the sky less since I started watching for you. Fair trade.", zh: "開始留意你之後,我看天的時間變少了。很划算。" },
  // neighbour
  { weight: 4, tier: 2, topic: "night", when: (c) => c.profession === "neighbour",
    en: "Left the stair light on. Not for anyone. For whoever.", zh: "樓梯的燈我留著。不為誰,為隨便哪個誰。" },
  { weight: 4, tier: 2, topic: "city", when: (c) => c.profession === "neighbour",
    en: "New tower went up Tuesday. I liked the empty lot too. Both can be true.", zh: "星期二又長了一棟樓。我也喜歡原本的空地。兩件事不衝突。" },
  { weight: 4, tier: 2, topic: "writing", when: (c) => c.profession === "neighbour",
    en: "I don't read much. But I like knowing someone's writing next door.", zh: "我書讀得不多。但知道隔壁有人在寫字,就覺得安心。" },
  { weight: 4, tier: 3, topic: "them", when: (c) => c.profession === "neighbour",
    en: "I've lived here longest and know the least. It's a way of staying.", zh: "我住最久,知道的最少。這也是一種住法。" },
  { weight: 5, tier: 4, topic: "you", when: (c) => c.profession === "neighbour",
    en: "Doors on this street don't lock. Yours started it.", zh: "這條街的門都不鎖了。是從你那扇開始的。" },
]
